...
void insertion(struct rbNode *newnode)
{
    ...
    while (ptr != NULL)
    {
        ...
        {
            printf("Duplicates Not Allowed!! %lld %lld\n", ptr->data, newnode->data);
            return;
        }
...
// Delete a node
void deletion(long long int data)
{
    struct rbNode *stack[98], *ptr, *xPtr, *yPtr;
...
int main()
{
    ...
    FILE *tempo;
    tempo = fopen("tempoinsercao_RB.txt", "w");
