...
int main()
{
    ...
    FILE *tempo_remocao_B;
    tempo_remocao_B = fopen("remocao_Btree2.txt", "w");

    FILE *tempo_consulta_B;
    tempo_consulta_B = fopen("consulta_Btree2.txt", "w");
